...
export const keyFeatures: FeatureChoices = {
    ...
    [FeatureId.BallotType]: BallotType.SingleChoice, // typically a party-list vote
    [FeatureId.MajorityGuarantee]: MajorityGuarantee.Yes,
    [FeatureId.Counting]: CountingRule.Plurality, // NOTE: outcome is built on proportional list allocation + a bonus; keep enum consistent with your schema
