...
export const introParagraph: string = `
  ...
  merely top the largest plurality.
`;
...
export const keyFeatures: FeatureChoices = {
    ...
    // For a single-winner method, proportionality does not apply.
    [FeatureId.Proportionality]: Proportionality.None,
    ...
    // Borda is sensitive to candidate sets (clone vulnerability), so raise these:
